...
fetchSpecification(
  selectCategorie,
  "https://devweb.iutmetz.univ-lorraine.fr/~riese3u/2A/SAE-4.01_Tag3/serveur/api/getCategories.php",
  "Catégorie",
  "idCategorie"
);
fetchSpecification(
  selectCouleur,
  "https://devweb.iutmetz.univ-lorraine.fr/~riese3u/2A/SAE-4.01_Tag3/serveur/api/getCouleurs.php",
  "Couleur",
  "idCouleur"
);
fetchSpecification(
  selectTaille,
  "https://devweb.iutmetz.univ-lorraine.fr/~riese3u/2A/SAE-4.01_Tag3/serveur/api/getTailles.php",
  "Taille",
  "idTaille"
);
...
selectCategorie.addEventListener("change", (e) => {
  e.preventDefault();
  fetch("https://devweb.iutmetz.univ-lorraine.fr/~riese3u/2A/SAE-4.01_Tag3/serveur/api/getProduits.php").then(
    (reponse) =>
      reponse.json().then((data) => {
        ...
        fetch("https://devweb.iutmetz.univ-lorraine.fr/~riese3u/2A/SAE-4.01_Tag3/serveur/api/getCouleurs.php").then(
          (reponse) =>
            reponse.json().then((data) => {
        ...
        fetch("https://devweb.iutmetz.univ-lorraine.fr/~riese3u/2A/SAE-4.01_Tag3/serveur/api/getTailles.php").then(
          (reponse) =>
            reponse.json().then((data) => {
