...
async function printCouleurs(infos_prod) {
    ...
    const json = await fetch('http://localhost/SAE-4.01/serveur/api/getCouleurs.php')
        .then(reponse => reponse.json());
...
async function printTailles(infos_prod) {
    ...
    const json = await fetch('http://localhost/SAE-4.01/serveur/api/getTailles.php')
        .then(reponse => reponse.json());
...
async function printOptionCat(id_cat) {
    ...
    const json = await fetch('http://localhost/SAE-4.01/serveur/api/getCategories.php')
        .then(reponse => reponse.json());
...
function ajouterProd(infos_prod) {
    fetch('http://localhost/SAE-4.01/serveur/api/ajoutProduit.php', {
        method: "POST",
