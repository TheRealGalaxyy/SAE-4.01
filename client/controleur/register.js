...
function register() {
  ...
  console.log(user);
  fetch("https://devweb.iutmetz.univ-lorraine.fr/~riese3u/2A/SAE-4.01_Final/serveur/api/newUser.php", {
    method: "POST",
    ...
    .then((data) => {
      ...
      if (data.status == "success") {
        ...
        fetch("https://devweb.iutmetz.univ-lorraine.fr/~riese3u/2A/SAE-4.01_Final/serveur/api/connexion.php", {
          method: "POST",
          body: new URLSearchParams({
            login: user.login,
            mdp: user.mdp,
