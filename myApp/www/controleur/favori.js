...
async function getFavori(id_us) {
    return await fetch("https://devweb.iutmetz.univ-lorraine.fr/~riese3u/2A/SAE-4.01_Tag1/serveur/api/getFavori.php", {
            method: "POST",
...
function btn() {
    ...
    produits.forEach((produit) => {
        ...
        button.addEventListener("click", (event) => {
            ...
            fetch("https://devweb.iutmetz.univ-lorraine.fr/~riese3u/2A/SAE-4.01_Tag1/serveur/api/delFavori.php", {
                method: "POST",
                body: new URLSearchParams({
                    id_us: id_us,
...
document.getElementById("clear").addEventListener("click", () => {
    fetch("https://devweb.iutmetz.univ-lorraine.fr/~riese3u/2A/SAE-4.01_Tag1/serveur/api/clearFavori.php", {
        method: "POST",
        body: new URLSearchParams({
            id_us: id_us,
        })
