...
async function getPanier(id_us) {
  return await fetch(
    "https://devweb.iutmetz.univ-lorraine.fr/~riese3u/2A/SAE-4.01_Tag1/serveur/api/getPanier.php",
    {
      method: "POST",
...
function delButton(id) {
  ...
  test.addEventListener("click", (e) => {
    ...
    fetch(
      "https://devweb.iutmetz.univ-lorraine.fr/~laroche5/SAE_401/serveur/api/delPanier.php",
      {
        method: "POST",
        body: new URLSearchParams({
          id_us: id_us,
...
function modifButton(id) {
  ...
  test.addEventListener("click", (e) => {
    ...
    fetch(
      "https://devweb.iutmetz.univ-lorraine.fr/~laroche5/SAE_401/serveur/api/setPanier.php",
      {
        method: "POST",
        body: new URLSearchParams({
          id_us: id_us,
...
function affichePanier(panier, qte, taille, couleur, couleurId, tailleId) {
  ...
  panierDiv.innerHTML = `
        ...
        <center><img id="img${id}" src="https://devweb.iutmetz.univ-lorraine.fr/~laroche5/SAE_401/serveur/img/articles/${
    panier.path_img
        ...
        BDDproduit.data.forEach((element) => {
          if (element.nom_col === e.target.value) {
            document.getElementById(
              `img${id}`
            ).src = `https://devweb.iutmetz.univ-lorraine.fr/~laroche5/SAE_401/serveur/img/articles/${element.path_img}`;
          }
        });
      });
    });
...
document.getElementById("clear").addEventListener("click", () => {
  fetch(
    "https://devweb.iutmetz.univ-lorraine.fr/~laroche5/SAE_401/serveur/api/clearPanier.php",
    {
      method: "POST",
      body: new URLSearchParams({
        id_us: id_us,
...
document.getElementById("payer").addEventListener("click", () => {
  fetch(
    "https://devweb.iutmetz.univ-lorraine.fr/~laroche5/SAE_401/serveur/api/payer.php",
    {
      method: "POST",
      body: new URLSearchParams({
        id_us: id_us,
