  ...
  connectedCallback() {
    ...
    <div class="produitDetail">
        ...
        <span class="main_info_prod">
            <center><img class="img_prod" alt="../img/Placeholder.png" src="${this.getAttribute(
              "path_img"
            )}"></center>
...
function imprimerProduit(produit) {
  let path = produit.path_img
    ? "https://devweb.iutmetz.univ-lorraine.fr/~laroche5/SAE_401/serveur/img/articles/" +
      produit.path_img
    : "https://developers.elementor.com/docs/assets/img/elementor-placeholder-image.png";
  //console.log(path)
...
function boutonCommander(id_produit) {
  ...
  boutton.addEventListener("click", (event) => {
    ...
    if (quantiteCommandeeValide(nbCommandee)) {
      ...
      fetch(
        "https://devweb.iutmetz.univ-lorraine.fr/~laroche5/SAE_401/serveur/api/newPanier.php",
        {
          method: "POST",
          body: new URLSearchParams({
            id_us: cookieValue,
